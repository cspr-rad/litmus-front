...
export default function Home() {
    return (
        <div
            ...
            <div
                className="absolute top-[120px] left-0 w-full z-0 overflow-hidden"
                ...
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 1000" preserveAspectRatio="none">
                    ...
                    <path
                        ...
                        d="M0,128L48,144C96,160,192,192,288,218.7C384,245,480,267,576,272C672,277,768,267,864,245.3C960,
                        224,1056,192,1152,186.7C1248,181,1344,203,1392,213.3L1440,224L1440,1000L0,1000Z">
                    </path>
                </svg>
            </div>

            <main className="relative z-10 flex-grow flex flex-col items-center justify-between p-1 sm:p-2 lg:p-12
                xl:p-24 pb-5">
